...
<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            <form id="contrato" action="{{route('usuarios.update',$user->id)}}" method="post">
                {{ csrf_field() }}
                <div class="form-body">
                    ...
                    <div class="row" style="margin-left: 25px;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Ciudad sadsad</label>
                    ...
                    <div class="row" style="margin-left: 25px;">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control custom-select" name="type_document">
                                    ...
                                    <option value="{{$document->id}}"{{ $document->id == $user->type_document ? 'selected' : '' }}>{{$document->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="cdocument" name="document" class="form-control" value="{{ old( 'document', $user->document) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group s">
                                ...
                                <select class="form-control custom-select" name="supervisor">
                                    ...
                                    <option value="{{$supervisor->id}}" {{ $supervisor->id == $user->supervisor ? 'selected' : '' }}>{{$supervisor->surname}} {{$supervisor->name}}</option>
                                    </option>
                                    @endforeach
                                </select>
