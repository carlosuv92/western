            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="validationCustom01">Proxima Visita</label>
                ...
                <div class="form-row m-t-15">
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="validationCustom02">Producto Interesado</label>
                        <select class="form-control custom-select" id="interesado" name="interesado">
                            <option value="POS PLAYA">POS PLAYA</option>
                            <option value="POKET JR">POKET JR</option>
                            <option value="POKET PRO">POKET PRO</option>
                            <option value="POKET FULL">POKET FULL</option>
                            <option value="POKET PRO">PAGO LINK</option>
                        </select>
                        <div class="valid-feedback">
                            Genial!
                        </div>
                ...
                <button class="btn btn-primary" type="submit">Generar Visita</button>
            </div>
        </div>
    </form>
    <script>
